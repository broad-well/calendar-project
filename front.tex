...
\begin{document}
	...
	\centering
	\begin{tikzpicture}[xscale=5,yscale=5,overlay]
		\draw[domain=-2:2,smooth,ultra thick,magenta!30!gray] plot ({\x},{tanh \x});
		\draw[domain=-2:2,smooth,ultra thick,yellow!30!gray] plot ({\x}, {\x});
		\draw[domain=-2:2,smooth,ultra thick,yellow!30!gray] plot ({\x}, {-\x});
		\draw[domain=-2:2,smooth,ultra thick,magenta!30!gray] plot ({\x},{-tanh \x});
		\draw[domain=-2:2,smooth,ultra thick,variable=\y,magenta!30!gray] plot ({tanh \y},{\y});
		\draw[domain=-2:2,smooth,ultra thick,variable=\y,magenta!30!gray] plot ({-tanh \y},{\y});
		\draw[domain=-1.44:1.44,smooth,ultra thick,orange!30!gray] plot ({\x},{sinh \x});
		\draw[domain=-1.44:1.44,smooth,ultra thick,variable=\y,orange!30!gray] plot ({sinh \y},{\y});
		\draw[domain=-1.44:1.44,smooth,ultra thick,orange!30!gray] plot ({\x},{-sinh \x});
		\draw[domain=-1.44:1.44,smooth,ultra thick,variable=\y,orange!30!gray] plot ({-sinh \y},{\y});
		\draw[domain=-2:2,smooth,ultra thick,red!30!gray] plot ({\x},{sinh (tanh \x)});
		\draw[domain=-2:2,smooth,ultra thick,variable=\y,red!30!gray] plot ({sinh (tanh \y)},{\y});
		\draw[domain=-2:2,smooth,ultra thick,red!30!gray] plot ({\x},{-sinh (tanh \x)});
		\draw[domain=-2:2,smooth,ultra thick,variable=\y,red!30!gray] plot ({-sinh (tanh \y)},{\y});
		\draw[ultra thick,blue!30!gray] (0,0) circle [radius=2];
