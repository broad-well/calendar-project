...
\begin{document}
	...
	\centering
	\begin{tikzpicture}[xscale=3.8,yscale=3.8,remember picture,overlay,shift={(current page.center)}]
		\draw[domain=-5:-0.1,smooth,ultra thick,magenta!20!gray] plot ({\x},{1/ \x});
		\draw[domain=0.1:5,smooth,ultra thick,magenta!20!gray] plot ({\x},{1/ \x});
		\draw[domain=-5:-0.1,smooth,ultra thick,yellow!20!gray] plot ({\x}, {-1/ \x});
		\draw[domain=0.1:5,smooth,ultra thick,yellow!20!gray] plot ({\x}, {-1/ \x});
		\draw[domain=-5:-0.1,smooth,ultra thick,orange!20!gray] plot ({\x}, {4/\x});
		\draw[domain=0.1:5,smooth,ultra thick,orange!20!gray] plot ({\x}, {4/\x});
		\draw[domain=-5:-0.1,smooth,ultra thick,magenta!20!gray] plot ({\x},{-4/\x});
		\draw[domain=0.1:5,smooth,ultra thick,magenta!20!gray] plot ({\x},{-4/\x});
		\draw[smooth,ultra thick,variable=\y,blue!20!gray] plot ({\y^2},{\y});
		\draw[smooth,ultra thick,variable=\y,blue!20!gray] plot ({-\y^2},{\y});
		\draw[smooth,ultra thick,orange!20!gray] plot ({\x},{\x^2});
		\draw[smooth,ultra thick,orange!20!gray] plot ({\x},{-\x^2});
		\draw[ultra thick,blue!20!gray] (0,0) circle [radius=1.44];
		\draw[ultra thick,blue!20!gray] (0,0) circle [radius=2.88];
	\end{tikzpicture}
		\begin{vplace}
	...
	\end{vplace}
			...
			{\large An adventure by Michael Peng}
	\end{center}
\end{document}