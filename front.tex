...
\usepackage{tikz}
\usepackage{geometry}
\geometry{letterpaper,left=0pt,top=0pt,right=0pt,bottom=10pt}
\usetikzlibrary{calc}
...
\begin{document}
	...
	\centering
	\begin{tikzpicture}[xscale=3.5,yscale=3.5,remember picture,overlay,shift={(current page.center)}]
		\draw[domain=-5:-0.1,smooth,ultra thick,magenta!30!gray] plot ({\x},{1/ \x});
		\draw[domain=0.1:5,smooth,ultra thick,magenta!30!gray] plot ({\x},{1/ \x});
		\draw[domain=-5:-0.1,smooth,ultra thick,yellow!30!gray] plot ({\x}, {-1/ \x});
		\draw[domain=0.1:5,smooth,ultra thick,yellow!30!gray] plot ({\x}, {-1/ \x});
		\draw[domain=-5:-0.1,smooth,ultra thick,yellow!30!gray] plot ({\x}, {4/\x});
		\draw[domain=0.1:5,smooth,ultra thick,yellow!30!gray] plot ({\x}, {4/\x});
		\draw[domain=-5:-0.1,smooth,ultra thick,magenta!30!gray] plot ({\x},{-4/\x});
		\draw[domain=0.1:5,smooth,ultra thick,magenta!30!gray] plot ({\x},{-4/\x});
		\draw[smooth,ultra thick,variable=\y,magenta!30!gray] plot ({\y^2},{\y});
		\draw[smooth,ultra thick,variable=\y,magenta!30!gray] plot ({-\y^2},{\y});
		\draw[smooth,ultra thick,orange!30!gray] plot ({\x},{\x^2});
		\draw[smooth,ultra thick,magenta!30!gray] plot ({\x},{-\x^2});
		\draw[ultra thick,blue!30!gray] (0,0) circle [radius=1.44];
		\draw[ultra thick,blue!30!gray] (0,0) circle [radius=2.88];
	\end{tikzpicture}
		\begin{vplace}
			...
			\node at (0,0,15) {\fontfamily{lmss} \fontsize{3cm}{15cm}\selectfont \textcolor{front}{THE}};
			\node at (20,0,-12) {\fontfamily{lmss} \fontsize{3cm}{15cm}\selectfont \textcolor{front}{PROJECT}};
			\end{tikzpicture}
			
	\end{vplace}
			{\Huge Discipline | Logic | Strategy }\\
			{\large An adventure administered by Michael Peng}
	\end{center}
\end{document}