...
\begin{document}
	...
	\begin{quotation}
		...
		Given that each circle is inscribed in a $1 \times 1$ square, they have a diameter of $1$ and therefore a radius of $\frac{d}{2}=\frac{1}{2}$. Using the circle area formula $r^2\pi$, it is determined that both circles have an area of $(\frac{1}{2})^2\pi=\frac{\pi}{4}$. The total area of two such circles is $2(\frac{\pi}{4})=\frac{\pi}{2} \textrm{unit}^2$. The $2 \times 1$ rectangle has an area of $2 \times 1=2 \textrm{unit}^2$. The fraction of the rectangle's area that lies within the two circles is $\frac{\frac{\pi}{2}}{2}=\pi \div 2 \div 2=\boxed{\frac{\pi}{4}}$. 
