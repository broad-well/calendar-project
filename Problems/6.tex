...
\begin{document}
	...
	\renewcommand{\arraystretch}{1.15}
		\begin{longtable}{|l p{0.41\linewidth} l p{0.41\linewidth}|}
			...
			\StatementReason{$\triangle GEF$ is an equiangular triangle}{Equilateral $\triangle$s are equiangular (8)}
			\StatementReason{$\text{m}\angle GEF=\text{m}\angle EFG=\text{m}\angle FGE=60$\textdegree}{The measure of each $\angle$ of an equiangular $\triangle$ is 60\textdegree \space(2)}
			% TODO \StatementReason{$\overline{EG},\overline{GF},\text{and }\overline{FE}$ are tangent to circle $O$.}
			\StatementReason{$\overline{AE}\cong\overline{HE}, \overline{BF}\cong\overline{HF}, \overline{AG}\cong\overline{BG}$}{2 segs. tangent to same circle from same ext. pt. $\rightarrow$ segs $\cong$ (6)}
			\StatementReason{$AE=HE, BF=HF, AG=BG$}{Definition of segment $\cong$}
			\StatementReason{$\angle GEF\cong\angle EFG\cong\angle FGE$}{Definition of equiangular $\triangle$s (2)}
			\StatementReason{$\overline{EG}\cong\overline{GF}\cong\overline{FE}$}{Definition of equilateral $\triangle$s (3)}
			...
			\StatementReason{$\triangle AEH\cong\triangle BFH\cong\triangle BGA$}{SAS (6)}
